...
install_XrayR() {
    ...
    file="https://github.com/qa12399999/XrayR-release/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/a12399999/XrayR-release/master/XrayR.sh
